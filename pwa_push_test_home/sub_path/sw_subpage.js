...
self.addEventListener('push', function (event) {
  console.log('[Service Worker - sw_subpage] Push Received.');
  console.log(`[Service Worker - sw_subpage] Push had this data:`,  event.data.json());

  // console.log(`[Service Worker] Push had this data: "${event.data.text()}"`);
  // const data = event.data.json().data;
  const title =  'sw_subpage.js push';
  const options = {
      // body: `${data.body}`,
